...
// $programa viene del ProgramaController::edit()
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Editar Programa — CECO Admin</title>
...
<main class="programa-main" id="programaMain">
    ...
    <div class="admin-topbar">
        ...
        <h1 class="topbar-title">Editar Programa</h1>
    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="fw-bold mb-1">
                    <i class="bi bi-pencil-square me-2 text-primary"></i>Editar Programa
                </h2>
                <p class="text-muted mb-0">Actualiza la información del programa seleccionado</p>
            </div>
        ...
        <form
            action="?page=admin_programas&action=actualizar&id=<?= (int)($programa['id'] ?? 0) ?>"
            method="POST"
                    ...
                    <div class="card border-0 shadow-sm rounded-4">
                        <div class="card-body p-3 d-flex flex-column gap-2">
                            <button type="submit" class="btn btn-primary w-100 shadow-sm">
                                <i class="bi bi-check2-circle me-2"></i>Actualizar programa
                            </button>
