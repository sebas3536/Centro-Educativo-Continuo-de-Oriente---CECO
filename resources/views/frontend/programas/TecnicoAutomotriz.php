    ...
    <div class="main-bg">
        ...
        <header class="hero-full">
            ...
            <div class="container text-center hero-content">
                ...
                <h1 class="my-3">
                 ...
                 <p class="subtitle">
                    Adquiere competencias para el sector automotriz con formación integral y reconocimiento oficial.
                    <strong class="fw-bold d-block mt-2" style="color: #FFE484;">¡Tu futuro en la mecánica comienza aquí!</strong>
                </p>
        ...
        <div class="container">
            ...
            <section class="text-center my-5 animate-on-scroll">
                ...
                <p class="section-sub">
                    El Técnico Laboral por Competencia en Automotriz te prepara para aplicar procesos de diagnóstico,
                    mantenimiento y reparación de vehículos automotores, con un enfoque práctico y alineado a los
            ...
            <div class="row g-4 my-5">
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        <i class="fas fa-engine feature-icon"></i>
                        <h3 class="mt-3" style="color: var(--text-dark);">Diagnóstico automotriz</h3>
                        <p class="text-muted">Desarrolla habilidades en diagnóstico y reparación de sistemas mecánicos y
                            eléctricos.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <h3 class="mt-3" style="color: var(--text-dark);">Mantenimiento vehicular</h3>
                        <p class="text-muted">Aprende técnicas de mantenimiento preventivo y correctivo en vehículos
                            automotores.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                ...
                <div class="row g-4 mt-3">
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                <li>Interés en adquirir conocimientos para el área automotriz.</li>
                    ...
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                ...
                                <li>Diagnosticador de vehículos</li>
                                <li>Técnico de mantenimiento automotriz</li>
                                <li>Especialista en sistemas eléctricos automotrices</li>
                            </ul>
                        </div>
                    </div>
                </div>
