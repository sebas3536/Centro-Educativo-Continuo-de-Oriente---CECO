    ...
    <div class="main-bg">
        ...
        <header class="hero-full">
            ...
            <div class="container text-center hero-content">
                ...
                <p class="subtitle">
                    Adquiere competencias para el sector empresarial con formación integral y reconocimiento oficial.
                    <strong class="fw-bold d-block mt-2" style="color: #FFE484;">¡Tu futuro en la administración comienza aquí!</strong>
                </p>
        ...
        <div class="container">
            ...
            <section class="text-center my-5 animate-on-scroll">
                ...
                <p class="section-sub">
                    El Técnico Laboral por Competencia en Auxiliar Administrativo te prepara para aplicar procesos administrativos, de gestión documental y apoyo en el entorno empresarial, con un enfoque práctico y alineado a las normativas vigentes.
                </p>
            </section>
            ...
            <div class="row g-4 my-5">
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <h3 class="mt-3" style="color: var(--text-dark);">Gestión documental</h3>
                        <p class="text-muted">Desarrolla habilidades en manejo de archivo, correspondencia y documentos empresariales.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        <i class="fas fa-users feature-icon"></i>
                        <h3 class="mt-3" style="color: var(--text-dark);">Apoyo administrativo</h3>
                        <p class="text-muted">Aprende a gestionar procesos administrativos y de atención al cliente.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <p class="text-muted">Egresarás con un perfil técnico que responde a las necesidades del sector empresarial.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4 mt-3">
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                <li>Interés en adquirir conocimientos para el área de Auxiliar Administrativo.</li>
                    ...
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                ...
                                <li>Auxiliar de admisiones</li>
                                <li>Auxiliar de documentación</li>
                                <li>Auxiliar radicación</li>
                                <li>Auxiliares de gestión del riesgo de desastres</li>
                                <li>Oficinista general</li>
                            </ul>
                        </div>
                    </div>
                </div>
