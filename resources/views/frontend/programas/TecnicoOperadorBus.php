    ...
    <div class="main-bg">
        ...
        <header class="hero-full">
            ...
            <div class="container text-center hero-content">
                ...
                <p class="subtitle">
                    Adquiere competencias para el sector del transporte con formación integral y reconocimiento oficial.
                    <strong class="fw-bold d-block mt-2" style="color: #FFE484;">¡Tu futuro en el volante comienza aquí!</strong>
                </p>
        ...
        <div class="container">
            ...
            <!-- ====== TARJETA DE PROGRAMA ====== -->
            <div class="card-custom p-4 p-md-5 my-4 animate-on-scroll"
                style="margin-top: -1rem !important; position: relative; z-index: 5; background: rgba(255,255,255,0.98); backdrop-filter: blur(2px);">
                <div class="row g-4 text-center">
                    ...
                    <div class="col-6 col-md program-item">
                        ...
                        <div class="value">0272</div>
                        <small class="text-muted">08 Marzo de 2024</small>
                    </div>
                </div>
            </div>
            ...
            <section class="text-center my-5 animate-on-scroll">
                ...
                <p class="section-sub">
                    El Técnico Laboral por Competencia en Operador de Bus y otros Medios de Transporte Colectivos y
                    Masivos te prepara para aplicar procesos de conducción, seguridad vial y atención al pasajero en el
                    entorno del transporte, con un enfoque práctico y alineado a la normativa vigente.
                </p>
            </section>
            ...
            <div class="row g-4 my-5">
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <h3 class="mt-3" style="color: var(--text-dark);">Conducción profesional</h3>
                        <p class="text-muted">Desarrolla habilidades en conducción de buses y vehículos de transporte
                            colectivo.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <h3 class="mt-3" style="color: var(--text-dark);">Atención al pasajero</h3>
                        <p class="text-muted">Aprende a brindar servicio de calidad y seguridad a los usuarios del
                            transporte.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <p class="text-muted">Egresarás con un perfil técnico que responde a las necesidades del sector
                            transporte.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4 mt-3">
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                <li>Interés en adquirir conocimientos para el área de medios de transportes.</li>
                                <li>Edad: 18 años mínimo y máximo 50 Años.</li>
                                <li>Poseer licencia de conducción de categoría C1 y C2, para el desempeño laboral a
                                    futuro.</li>
                    ...
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                <li>Conductor de bus</li>
                                <li>Conductor de bus de turismo</li>
                                <li>Conductor de bus escolar</li>
                                <li>Operador de bus articulado</li>
                                <li>Operador de bus biarticulado</li>
                                <li>Operador de bus intermunicipal</li>
                                <li>Operadores de otros medios de transporte colectivo y masivo</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <section class="my-5 animate-on-scroll">
                ...
                <div class="card-custom p-4 p-md-5 mt-3">
                    <div class="d-flex flex-wrap gap-3 justify-content-center">
                        ...
                        <span class="doc-item"><i class="fas fa-car"></i> Licencia C1 y C2</span>
            ...
            <!-- ====== LOGOS ====== -->
            <div class="logos d-flex flex-wrap justify-content-center gap-4 py-4 my-4 border-top border-bottom"
