    ...
    <div class="main-bg">
        ...
        <header class="hero-full">
            ...
            <div class="container text-center hero-content">
                ...
                <p class="subtitle">
                    Adquiere competencias para el sector fluvial con formación integral y reconocimiento oficial.
                    <strong class="fw-bold d-block mt-2" style="color: #FFE484;">¡Tu futuro en el agua comienza
                        aquí!</strong>
                </p>
                <div class="d-flex flex-wrap gap-3 justify-content-center">
                    <a href="#" class="btn btn-primary-custom"><i class="fas fa-paper-plane me-2"></i> Inscríbete
                        ahora</a>
        ...
        <div class="container">
            ...
            <div class="card-custom p-4 p-md-5 my-4 animate-on-scroll"
                style="margin-top: -4rem !important; position: relative; z-index: 5; background: rgba(255,255,255,0.98); backdrop-filter: blur(2px);">
                <div class="row g-4 text-center">
                    ...
                    <div class="col-6 col-md program-item">
                        ...
                        <div class="value">0263</div>
                        <small class="text-muted">16 de Marzo de 2026</small>
                    </div>
                </div>
            </div>
            ...
            <section class="text-center my-5 animate-on-scroll">
                ...
                <p class="section-sub">
                    El Técnico Laboral por Competencia en Marinero de Embarcaciones Fluviales te prepara para aplicar
                    procesos operativos, de seguridad y maniobra en el entorno fluvial, con un enfoque práctico y
            ...
            <div class="row g-4 my-5">
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <h3 class="mt-3" style="color: var(--text-dark);">Formación práctica</h3>
                        <p class="text-muted">Desarrolla habilidades en alistamiento de equipos, guardia de navegación y
                            maniobras reales.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <h3 class="mt-3" style="color: var(--text-dark);">Seguridad y normativa</h3>
                        <p class="text-muted">Mantén la seguridad de la vida humana, la carga y el medio ambiente según
                            la ley.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                ...
                <div class="row g-4 mt-3">
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                <li>Interés en adquirir conocimientos para el área de Marinero fluvial.</li>
                                <li>Embarcaciones mayores de 18 años.</li>
                    ...
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                <li>Alista equipos de cubierta según procedimientos.</li>
                                <li>Presta servicios de guardia de navegación.</li>
                                <li>Mantiene la seguridad humana, de carga y ambiental.</li>
                                <li>Apoya maniobras de embarcaciones.</li>
                            </ul>
                        </div>
                    </div>
                </div>
