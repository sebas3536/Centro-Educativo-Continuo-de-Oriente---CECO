    ...
    <div class="main-bg">
        ...
        <header class="hero-full">
            ...
            <div class="container text-center hero-content">
                ...
                <p class="subtitle">
                    Adquiere competencias para el sector tecnológico con formación integral y reconocimiento oficial.
                    <strong class="fw-bold d-block mt-2" style="color: #FFE484;">¡Tu futuro en la tecnología comienza aquí!</strong>
                </p>
        ...
        <div class="container">
            ...
            <section class="text-center my-5 animate-on-scroll">
                ...
                <p class="section-sub">
                    El Técnico Laboral por Competencia en Sistemas Informáticos y Desarrollo de Software te prepara para aplicar procesos de programación, soporte técnico y desarrollo de aplicaciones en el entorno tecnológico, con un enfoque práctico y alineado a las tendencias del mercado digital.
                </p>
            </section>
            ...
            <div class="row g-4 my-5">
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <h3 class="mt-3" style="color: var(--text-dark);">Desarrollo de software</h3>
                        <p class="text-muted">Aprende a programar y diseñar aplicaciones informáticas de mediana complejidad.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        <i class="fas fa-server feature-icon"></i>
                        <h3 class="mt-3" style="color: var(--text-dark);">Soporte técnico</h3>
                        <p class="text-muted">Desarrolla habilidades en soporte de sistemas informáticos en el sector industrial, comercial y de servicios.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <p class="text-muted">Egresarás con un perfil técnico que responde a las necesidades del sector tecnológico.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4 mt-3">
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                <li>Interés en adquirir conocimientos para el área de Sistemas Informáticos y desarrollo de software.</li>
                    ...
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                <li>Diseñador de aplicaciones informáticas de mediana complejidad</li>
                                <li>Coordinador de procesos administrativos que requieren los sistemas de información en empresas industriales, comerciales y de servicios</li>
                                <li>Soporte técnico de sistemas informáticos en el sector industrial, comercial y de servicios</li>
                                <li>Programador en desarrollo y diseño de software</li>
                                <li>Coordinador de proyectos informáticos</li>
                            </ul>
                        </div>
                    </div>
                </div>
