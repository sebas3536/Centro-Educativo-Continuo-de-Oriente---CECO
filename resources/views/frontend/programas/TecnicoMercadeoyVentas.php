    ...
    <div class="main-bg">
        ...
        <header class="hero-full">
            ...
            <div class="container text-center hero-content">
                ...
                <p class="subtitle">
                    Adquiere competencias para el sector comercial con formación integral y reconocimiento oficial.
                    <strong class="fw-bold d-block mt-2" style="color: #FFE484;">¡Tu futuro en el marketing comienza aquí!</strong>
                </p>
        ...
        <div class="container">
            ...
            <div class="card-custom p-4 p-md-5 my-4 animate-on-scroll" style="margin-top: -4rem !important; position: relative; z-index: 5; background: rgba(255,255,255,0.98); backdrop-filter: blur(2px);">
                <div class="row g-4 text-center">
                    ...
                    <div class="col-6 col-md program-item">
                        ...
                        <div class="value">0415</div>
                        <small class="text-muted">21 de Julio de 2020</small>
                    </div>
                </div>
            </div>
            ...
            <section class="text-center my-5 animate-on-scroll">
                ...
                <p class="section-sub">
                    El Técnico Laboral por Competencia en Mercadeo y Ventas te prepara para aplicar procesos de comercialización, estrategias de marketing y gestión de ventas en el entorno empresarial, con un enfoque práctico y alineado a las tendencias del mercado.
                </p>
            </section>
            ...
            <div class="row g-4 my-5">
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <h3 class="mt-3" style="color: var(--text-dark);">Estrategias de marketing</h3>
                        <p class="text-muted">Desarrolla habilidades en planificación y ejecución de estrategias comerciales.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        <i class="fas fa-handshake feature-icon"></i>
                        <h3 class="mt-3" style="color: var(--text-dark);">Gestión de ventas</h3>
                        <p class="text-muted">Aprende a gestionar procesos de ventas y atención al cliente.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <p class="text-muted">Egresarás con un perfil técnico que responde a las necesidades del sector comercial.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4 mt-3">
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                <li>Interés en adquirir conocimientos para el área de mercadeo y ventas.</li>
                    ...
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                <li>Agentes de Mercadeo y ventas</li>
                                <li>Coordinadores del Departamento de Mercadeo y Ventas</li>
                                <li>Asistente Técnico de Proyectos Culturales</li>
                                <li>Consultores en Mercadeo y Ventas</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <section class="my-5 animate-on-scroll">
                ...
                <div class="card-custom p-4 p-md-5 mt-3">
                    <div class="d-flex flex-wrap gap-3 justify-content-center">
                        ...
                        <span class="doc-item"><i class="fas fa-folder"></i> Carpeta colgante</span>
