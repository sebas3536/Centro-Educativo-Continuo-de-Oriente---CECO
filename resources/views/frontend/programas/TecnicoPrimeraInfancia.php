    ...
    <div class="main-bg">
        ...
        <header class="hero-full">
            ...
            <div class="container text-center hero-content">
                ...
                <p class="subtitle">
                    Adquiere competencias para el sector educativo con formación integral y reconocimiento oficial.
                    <strong class="fw-bold d-block mt-2" style="color: #FFE484;">¡Tu futuro en la educación comienza aquí!</strong>
                </p>
        ...
        <div class="container">
            ...
            <section class="text-center my-5 animate-on-scroll">
                ...
                <p class="section-sub">
                    El Técnico Laboral por Competencia en Asistente de Primera Infancia te prepara para aplicar procesos educativos, de cuidado y desarrollo infantil en la primera infancia, con un enfoque práctico y alineado a las normativas educativas vigentes.
                </p>
            </section>
            ...
            <div class="row g-4 my-5">
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        <i class="fas fa-hands-child feature-icon"></i>
                        <h3 class="mt-3" style="color: var(--text-dark);">Desarrollo infantil</h3>
                        <p class="text-muted">Aprende sobre el desarrollo integral de niños y niñas en la primera infancia.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        <i class="fas fa-school feature-icon"></i>
                        <h3 class="mt-3" style="color: var(--text-dark);">Educación y cuidado</h3>
                        <p class="text-muted">Desarrolla habilidades en pedagogía, cuidado y estimulación temprana.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <p class="text-muted">Egresarás con un perfil técnico que responde a las necesidades del sector educativo.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4 mt-3">
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                <li>Interés en adquirir conocimientos para el área de asistente de primera Infancia.</li>
