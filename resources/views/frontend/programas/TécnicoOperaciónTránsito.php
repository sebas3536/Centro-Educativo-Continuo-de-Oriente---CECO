    ...
    <div class="main-bg">
        ...
        <header class="hero-full">
            ...
            <div class="container text-center hero-content">
                ...
                <p class="subtitle">
                    ...
                    <strong class="fw-bold d-block mt-2" style="color: #FFE484;">¡Tu futuro en la movilidad comienza aquí!</strong>
                </p>
        ...
        <div class="container">
            ...
            <section class="text-center my-5 animate-on-scroll">
                ...
                <p class="section-sub">
                    El Técnico Laboral por Competencia en Operación Tránsito, Transporte y Seguridad Vial te prepara para aplicar procesos operativos, de control y seguridad vial en el entorno del transporte, con un enfoque práctico y alineado a la normativa vigente.
                </p>
            </section>
            ...
            <div class="row g-4 my-5">
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <h3 class="mt-3" style="color: var(--text-dark);">Operación vial</h3>
                        <p class="text-muted">Desarrolla habilidades en control de tránsito, gestión de movilidad y seguridad en las vías.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        <i class="fas fa-shield-alt feature-icon"></i>
                        <h3 class="mt-3" style="color: var(--text-dark);">Seguridad vial</h3>
                        <p class="text-muted">Aplica normativas de tránsito y transporte para garantizar la seguridad de todos los actores viales.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <p class="text-muted">Egresarás con un perfil técnico que responde a las necesidades del sector transporte.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4 mt-3">
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                <li>Interés en adquirir conocimientos para el área de operación Tránsito, Transporte y Seguridad Vial.</li>
                    ...
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                <li>Supervisor de tránsito</li>
                                <li>Técnico de tránsito</li>
                                <li>Técnico operativo de tránsito</li>
                                <li>Técnicos operativos de tránsito</li>
                            </ul>
                        </div>
                    </div>
                </div>
