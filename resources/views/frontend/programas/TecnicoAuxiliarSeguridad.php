    ...
    <div class="main-bg">
        ...
        <header class="hero-full">
            ...
            <div class="container text-center hero-content">
                ...
                <p class="subtitle">
                    Adquiere competencias para el sector industrial con formación integral y reconocimiento oficial.
                    <strong class="fw-bold d-block mt-2" style="color: #FFE484;">¡Tu futuro en la seguridad laboral comienza aquí!</strong>
                </p>
        ...
        <div class="container">
            ...
            <section class="text-center my-5 animate-on-scroll">
                ...
                <p class="section-sub">
                    El Técnico Laboral por Competencia en Auxiliar de Seguridad Industrial y Ocupacional te prepara para
                    aplicar procesos de prevención, control de riesgos y seguridad en el entorno laboral, con un enfoque
                    práctico y alineado a la normativa vigente.
                </p>
            </section>
            ...
            <div class="row g-4 my-5">
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <h3 class="mt-3" style="color: var(--text-dark);">Prevención de riesgos</h3>
                        <p class="text-muted">Desarrolla habilidades en identificación y control de riesgos laborales.
                        </p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <h3 class="mt-3" style="color: var(--text-dark);">Seguridad ocupacional</h3>
                        <p class="text-muted">Aprende a implementar sistemas de gestión de seguridad y salud en el
                            trabajo.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                ...
                <div class="row g-4 mt-3">
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                <li>Interés en adquirir conocimientos para el área de seguridad industrial y
                                    ocupacional.</li>
                    ...
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                ...
                                <li>Técnico auxiliar de seguridad ocupacional</li>
                                <li>Técnico auxiliar en seguridad ocupacional y laboral</li>
                            </ul>
                        </div>
                    </div>
                </div>
