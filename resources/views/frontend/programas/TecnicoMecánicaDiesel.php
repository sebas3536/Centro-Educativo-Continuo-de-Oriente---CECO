    ...
    <div class="main-bg">
        ...
        <div class="container">
            ...
            <div class="card-custom p-4 p-md-5 my-4 animate-on-scroll" style="margin-top: -4rem !important; position: relative; z-index: 5; background: rgba(255,255,255,0.98); backdrop-filter: blur(2px);">
                <div class="row g-4 text-center">
                    ...
                    <div class="col-6 col-md program-item">
                        ...
                        <div class="value">0695</div>
                        <small class="text-muted">1 de Agosto de 2022</small>
                    </div>
                </div>
            </div>
            ...
            <section class="text-center my-5 animate-on-scroll">
                ...
                <p class="section-sub">
                    El Técnico Laboral por Competencia en Mecánica Diésel te prepara para aplicar procesos de diagnóstico, mantenimiento y reparación de motores diésel en el sector automotriz, con un enfoque práctico y alineado a los estándares de la industria.
                </p>
            </section>
            ...
            <div class="row g-4 my-5">
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <h3 class="mt-3" style="color: var(--text-dark);">Diagnóstico mecánico</h3>
                        <p class="text-muted">Desarrolla habilidades en diagnóstico y reparación de motores diésel de vehículos.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        <i class="fas fa-tools feature-icon"></i>
                        <h3 class="mt-3" style="color: var(--text-dark);">Mantenimiento especializado</h3>
                        <p class="text-muted">Aprende técnicas de alineación, sincronización y reparación de sistemas mecánicos.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <p class="text-muted">Egresarás con un perfil técnico que responde a las necesidades del sector automotriz.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4 mt-3">
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                <li>Interés en adquirir conocimientos para el área de Mecánica Diésel.</li>
                    ...
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                <li>Alineador mecánico</li>
                                <li>Alineador y sincronizador</li>
                                <li>Mecánico de alineación y suspensión</li>
                                <li>Mecánico de motores diésel de vehículos de motor</li>
                                <li>Reparador de ciclomotores</li>
                            </ul>
                        </div>
                    </div>
                </div>
