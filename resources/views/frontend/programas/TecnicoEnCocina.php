...
<head>
    ...
    <title>CECO · <?= htmlspecialchars($programa['titulo']) ?></title>
    ...
    <div class="main-bg">
        ...
        <header class="hero-full">
            ...
            <div class="container text-center hero-content">
                ...
                <p class="subtitle">
                    Adquiere competencias para el sector gastronómico con formación integral y reconocimiento oficial.
                    <strong class="fw-bold d-block mt-2" style="color: #FFE484;">¡Tu futuro en la cocina comienza aquí!</strong>
                </p>
        ...
        <div class="container">
            ...
            <div class="card-custom p-4 p-md-5 my-4 animate-on-scroll" style="margin-top: -4rem !important; position: relative; z-index: 5; background: rgba(255,255,255,0.98); backdrop-filter: blur(2px);">
                <div class="row g-4 text-center">
                    ...
                    <div class="col-6 col-md program-item">
                        ...
                        <div class="value highlight">$ 6.000.000</div>
            ...
            <section class="text-center my-5 animate-on-scroll">
                ...
                <p class="section-sub">
                    El Técnico Laboral por Competencia en Cocina te prepara para aplicar procesos culinarios, técnicas de preparación y gestión de cocina en el entorno gastronómico, con un enfoque práctico y alineado a los estándares de calidad.
                </p>
            </section>
            ...
            <div class="row g-4 my-5">
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        <i class="fas fa-kitchen-set feature-icon"></i>
                        <h3 class="mt-3" style="color: var(--text-dark);">Técnicas culinarias</h3>
                        <p class="text-muted">Desarrolla habilidades en preparación de alimentos, cocina internacional y dietas especiales.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        <i class="fas fa-utensil-spoon feature-icon"></i>
                        <h3 class="mt-3" style="color: var(--text-dark);">Gestión de cocina</h3>
                        <p class="text-muted">Aprende a gestionar recursos, control de calidad y seguridad alimentaria en la cocina.</p>
                    </div>
                </div>
                <div class="col-md-4 animate-on-scroll">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <p class="text-muted">Egresarás con un perfil técnico que responde a las necesidades del sector gastronómico.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4 mt-3">
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                <li>Interés en adquirir conocimientos para el área de Cocina.</li>
                    ...
                    <div class="col-md-6 animate-on-scroll">
                        <div class="profile-box">
                            ...
                            <ul>
                                <li>Cocinero</li>
                                <li>Cocinero barco</li>
                                <li>Cocinero campamentos de trabajo</li>
                                <li>Cocinero cocina fría</li>
                                <li>Cocinero cocina internacional</li>
                                <li>Cocinero dietas especiales</li>
                                <li>Cocinero principal</li>
                                <li>Cocinero restaurante</li>
                                <li>Hornero asadero</li>
                                <li>Parrillero</li>
                                <li>Parrillero asador carnes</li>
                            </ul>
                        </div>
                    </div>
                </div>
